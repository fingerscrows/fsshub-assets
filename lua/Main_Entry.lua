--[[
    FSSHUB Main Entry - Two-File Architecture Bootstrapper
    Version: 1.0.0

    This lightweight bootstrapper handles:
    - Workspace initialization with clean migration
    - Version validation via /health endpoint (SHA256)
    - Local cache management (UI_Bundle)
...
local function Log(msg)
    if CONFIG.Debug then
        print("[FSSHUB Entry]: " .. tostring(msg))
    end
end
